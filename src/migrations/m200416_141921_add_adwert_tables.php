...
CREATE TABLE `ads_banner` (
  ...
  `show_remains` bigint(16) unsigned NOT NULL DEFAULT '0' COMMENT 'Остаток показов',
  `cnt_show` BIGINT(16) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Показы',
  `cnt_click` BIGINT(16) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Переходы',
